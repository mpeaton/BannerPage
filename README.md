...
- **Video**: `html/resources/amdg-animation-final.mp4` (landscape: 2x2 left + text right; with original audio track; sound toggle available on site) + `html/resources/amdg-animation-final-portrait.mp4` (portrait: 2x2 on top + text underneath, 720x1104 from exact partitioned original frames) + poster `amdg-poster.png`
